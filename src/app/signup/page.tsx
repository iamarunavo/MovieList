  ...
  return (
    <div className="min-h-screen bg-dark-deep flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-md bg-dark-surface border border-white/15 rounded-2xl p-8 shadow-[0_16px_48px_rgba(0,0,0,0.7)]">
        ...
        <p className="text-white/50 text-sm mb-6">Join LaxMovies today</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className={inputClass}
            />
            <p className="mt-1 text-xs text-white/30">Must be at least 6 characters</p>
          </div>
          <div>
        ...
        <p className="mt-6 text-center text-white/40 text-sm">
          ...
          <Link href="/login" className="text-pink-brand hover:underline font-medium">
            Sign In
          </Link>
        </p>
      </div>
